///@func ecf_test_collision_rectangle_ext()
///@desc Test collision_rectangle_ext(x1, y1, x2, y2, objs, prec, notme, [suchthat])
function ecf_test_collision_rectangle_ext() {
	// Create test objects
	...
	assert_equal(collision_rectangle_ext(x, y, x+20, y+20, objEcfTester, false, false), id);
	assert_equal(collision_rectangle_ext(x, y, x+20, y+20, objEcfTester, false, true), noone);
	...
	assert_equal(collision_rectangle_ext(x, y, x+20, y+20, objEcfTester, false, false, [valueEqualTo, 4]), id);
	assert_equal(collision_rectangle_ext(x, y, x+20, y+20, objEcfTester, false, true, [valueEqualTo, 4]), noone);
	assert_equal(collision_rectangle_ext(x, y, x+20, y+20, [objEcfTester, pobjTarget], false, true, [valueEqualTo, 4]), t2c);
