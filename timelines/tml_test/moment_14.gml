///@desc collision_line_list_ext(x1, y1, x2, y2, objs, prec, notme, list, ordered, [suchthat])
...
ds_list_clear(list);
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget2], false, false, list, true), 4);
assert_equal(ds_list_to_array(list), [id, t2a, t2b, t2c]);
ds_list_clear(list);
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget2], false, true, list, true), 3);
assert_equal(ds_list_to_array(list), [t2a, t2b, t2c]);
ds_list_clear(list);
...
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget1], false, false, list, true, valueEqualToMe), 2);
assert_equal(ds_list_to_array(list), [id, t1b]);
ds_list_clear(list);
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget1], false, true, list, true, valueEqualToMe), 1);
assert_equal(ds_list_to_array(list), [t1b]);
ds_list_clear(list);
...
ds_list_clear(list);
value = 5; // Set just for the upcoming test
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget1], false, false, list, true, [valueEqualTo, 5]), 2);
assert_equal(ds_list_to_array(list), [id, t1b]);
ds_list_clear(list);
assert_equal(collision_line_list_ext(x-100, y, x+100, y, [objTester, objTarget1], false, true, list, true, [valueEqualTo, 5]), 1);
assert_equal(ds_list_to_array(list), [t1b]);
ds_list_clear(list);
value = 4; // Back to default
