///@desc instance_furthest_ext(x, y, objs, [suchthat])
...
assert_equal(instance_furthest_ext(x+20, y+20, objTester), id);
...
assert_equal(instance_furthest_ext(x, y, objTester, [valueEqualTo, 4]), id);
assert_equal(instance_furthest_ext(x-1000, y, [objTester, pobjTarget], [valueEqualTo, 4]), t2c);
