///@desc collision_point_ext(x, y, objs, prec, notme, [suchthat])
...
assert_equal(collision_point_ext(x, y, objTester, false, false), id);
assert_equal(collision_point_ext(x, y, objTester, false, true), noone);
...
assert_equal(collision_point_ext(x, y, objTester, false, false, [valueEqualTo, 4]), id);
assert_equal(collision_point_ext(x, y, objTester, false, true, [valueEqualTo, 4]), noone);
assert_equal(collision_point_ext(x, y, [objTester, pobjTarget], false, true, [valueEqualTo, 4]), t2c);
